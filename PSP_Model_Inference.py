...
# output_folder = os.path.expanduser("~/Desktop/Tese/PSPDados/PSP_DC_SoftCSRNETP_F16")

# model_path = os.path.expanduser("~/Desktop/Tese/CrowdCountingUAV/Results/PSP_DC_Soft_CSRNETP_QAT")
