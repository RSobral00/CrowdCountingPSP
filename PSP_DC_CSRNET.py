# Fine tuning CSRNet no conjunto de dados da PSP
...
model_path = os.path.expanduser("~/Desktop/Tese/CrowdCountingPSP/Results/CSRNET_Model")
...
opt = tf.keras.optimizers.SGD(learning_rate=5e-7, momentum=0.95)
...
filename = os.path.expanduser("~/Desktop/Tese/CrowdCountingPSP/Results/PSP_DC_CSRNET_history.csv")
...
pretrained_model.save(os.path.expanduser("~/Desktop/Tese/CrowdCountingPSP/Results/PSP_DC_CSRNET"))
print("Fitted Model")