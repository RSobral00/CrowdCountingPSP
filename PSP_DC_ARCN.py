# Fine tuning da ARCN no conjunto de dados da PSP
...
for layer in pretrained_model.layers[-109:]:
...
opt =tfa.optimizers.AdamW(learning_rate=2.5e-6,weight_decay=2.5e-6)   
...
filename = os.path.expanduser("~/Desktop/Tese/CrowdCountingPSP/Results/PSP_DC_ARCN_history.csv")
...
pretrained_model.save(os.path.expanduser("~/Desktop/Tese/CrowdCountingPSP/Results/PSP_DC_ARCN"))
